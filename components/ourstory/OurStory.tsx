...
export function OurStory() {
  return (
    <div className="relative w-full overflow-hidden bg-gray-900 flex items-center justify-center py-16">
      <div className="absolute inset-0 w-full h-full bg-gray-950 z-10 [mask-image:radial-gradient(transparent,white)] pointer-events-none" />
      ...
      <div className="relative z-20 flex flex-col md:flex-row w-11/12 lg:w-3/4 xl:w-2/3 bg-gray-900 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/4 bg-gray-700 p-6 flex items-center justify-start md:justify-center">
          <h1 className={cn("text-4xl font-bold text-white")}>Our Story</h1>
        </div>
        ...
        <div className="w-full md:w-3/4 p-8 flex flex-col justify-between space-y-4">
          <p className="text-lg leading-relaxed text-neutral-300">
            ...
            <br />
            <br />
            Between <strong className="text-indigo-400">
              Digital tools
            </strong>,{" "}
            <strong className="text-indigo-400">
              Advertising Manufacturing
            </strong>
            , and <strong className="text-indigo-400">Creative Art</strong>,
            lied our dream.
          </p>
