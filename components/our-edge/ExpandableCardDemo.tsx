  ...
  return (
    <BackgroundBeamsWithCollision>
      <div
        id="OurEdge"
        ref={sectionRef}
        className="relative w-full flex leading-tight flex-col items-start justify-start py-32 bg-gradient-to-b from-[rgba(43,43,43,0.7)] via-[rgba(58,48,48,0.20)] to-[rgba(41,34,34,0.7)] min-h-[80px]"
      >
        <motion.div
